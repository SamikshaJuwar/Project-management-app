...
export default async function ManagerOverviewPage() {
  ...
  const stats = [
    { label: "Total Employees",     value: totalEmployees,     href: "/dashboard/manager/employees",  color: "bg-blue-50 text-blue-700"  },
    { label: "Present Today",       value: todayAttendance,    href: "/dashboard/manager/attendance",  color: "bg-green-50 text-green-700" },
    { label: "Pending Timesheets",  value: pendingTimesheets,  href: "/dashboard/manager/timesheets",  color: "bg-amber-50 text-amber-700" },
  ];
    ...
    <div className="p-8">
      ...
      <div className="mt-10">
        ...
        <div className="flex gap-3 flex-wrap">
          <Link href="/dashboard/manager/employees/new"
          ...
          <Link href="/dashboard/manager/timesheets"
            className="text-sm px-4 py-2 border border-gray-300 rounded-md hover:bg-gray-50 transition-colors">
            Review Timesheets
          </Link>
        </div>
